...
2. Not using one of the built-in framework adapters? Wire `restaq.handler` into your framework's request handling yourself — see [Installation](/docs/installation) step 7.
