---
title: Installation
description: Set up Restaq step by step, from install to your first mounted webhook route
---
...
- **CLI reference**: `relay trigger` and `relay replay` read the `RESTAQ_BASE_URL` you set in step 2 to know where to POST — see the [CLI reference](/docs/cli) for every command and env var it reads.
