...
The `@restaq/github` plugin handles [GitHub webhook](https://docs.github.com/en/webhooks) verification and provides a fully-typed event catalog for all GitHub webhook events.
...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  ...
  <Tab value="npm">
  ```sh
  npm install @restaq/github
  ```
  </Tab>
  <Tab value="yarn">
  ```sh
  yarn add @restaq/github
  ```
  </Tab>
  <Tab value="bun">
  ```sh
  bun add @restaq/github
  ```
  </Tab>
</Tabs>
