...
// Now when you pass myPlugin to restaq, relay.on() autocompletes the event names
...
- [@restaq/plugin](/docs/reference/plugin) — the `definePlugin` and HMAC helpers used above
- [@restaq/stripe](/docs/reference/stripe) — a real plugin implementation to read alongside this guide
