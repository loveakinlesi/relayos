...
Here's a real example that demonstrates why durable steps matter (registered in `relay.handlers.ts` — see [Organizing handlers](/docs/concepts/events#organizing-handlers)):
