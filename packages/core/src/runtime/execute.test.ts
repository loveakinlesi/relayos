...
vi.mock("../context/create-context.js", () => ({
  createContext: vi.fn(),
}));

vi.mock("../plugins/resolve-handler.js", () => ({
  resolveHandler: vi.fn(),
}));

vi.mock("../retry/scheduler.js", () => ({
  scheduleRetry: vi.fn(),
}));

import { createContext } from "../context/create-context.js";
import { findEventById } from "../persistence/events.repo.js";
import { findExecutionById, updateExecutionStatus } from "../persistence/executions.repo.js";
